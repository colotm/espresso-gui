...
const menuItems = [
        ...
        },
    {
        ...
        tags: ['penguinmod'],
        description: 'Extra blocks for you to use, provided by the espresso team.',
        featured: true
    },
    {
        name: (
    ...
    },
    {
        ...
        tags: ['extcreate'],
        featured: true,
        disabled: !noLiveTestsOverride & !(IsLocal || IsLiveTests)
    },
    {
        // not really an extension, but it's easiest to present it as one
...
----------------------------------------------
*/
if (!noLiveTestsOverride && (IsLocal || IsLiveTests)) {
    const extras = [
        {
            name: (
                <FormattedMessage
