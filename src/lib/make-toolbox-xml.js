...
const sensing = function (isInitialSetup, isStage) {
    ...
    const exampleKey = "somefile";
    const exampleValue = "Hello world!";
    const exampleLocalKey = "sometext";
    ...
    <category name="%{BKY_CATEGORY_SENSING}" id="sensing" colour="#4CBFE6" secondaryColour="#2E8EB8">
        ${isStage ? '' : `
            ...
            ${blockSeparator}
            <block type="sensing_uploaddata">
                <value name="DATA_KEY">
                    <shadow type="text">
                        <field name="TEXT">${exampleKey}</field>
                    </shadow>
                </value>
                <value name="DATA_VALUE">
                    <shadow type="text">
                        <field name="TEXT">${exampleValue}</field>
                    </shadow>
                </value>
            </block>
            <block type="sensing_uploaddatalocal">
                <value name="DATA_KEY">
                    <shadow type="text">
                        <field name="TEXT">${exampleLocalKey}</field>
                    </shadow>
                </value>
                <value name="DATA_VALUE">
                    <shadow type="text">
            ...
            <block type="sensing_getdatalocal">
                <value name="DATA_KEY">
                    <shadow type="text">
                        <field name="TEXT">${exampleKey}</field>
                    </shadow>
...
${blockSeparator}
        ...
        <comment>
        Commenting this out, cuz there's already a js timestamp block and i forgort about it :skul:
        <block type="sensing_unixtimestamp"/>
        </comment>
        ${blockSeparator}
...
const strings = function (isInitialSetup, isStage, targetId) {
    const hello = "Hello world!";
    const apple = "apple";
    const banana = "banana";
    const letter = "a";
    return `
    <category name="Strings" id="strings" colour="#32a895" secondaryColour="#154a41">
        ...
        <block type="strings_random"></block>
        <block type="operator_newLine"></block>
            ...
            ${blockSeparator}
            <block type="strings_encode">
                <field name="METHOD">BASE64</field>
                <value name="TEXT">
                    <shadow type="text">
                        <field name="TEXT">hello world!</field>
                    </shadow>
            ...
            <block type="strings_decode">
                <field name="METHOD">BASE64</field>
                <value name="TEXT">
                    <shadow type="text">
                        <field name="TEXT">encoded</field>
                    </shadow>
                </value>
            </block>
    </category>
...
const makeToolboxXML = function (isInitialSetup, isStage = true, targetId, categoriesXML = [],
    ...
    const stringsXML = moveCategory('strings') || strings(isInitialSetup, isStage, targetId)
    ...
    //force no live tests category if "production" url param is true
    const urlParams = new URLSearchParams(location.search);

    const IsLocal = String(window.location.href).startsWith(`http://localhost:`);
    const noLiveTestsOverride = IsLocal && urlParams.has('production');
    if (!noLiveTestsOverride && isLiveTest) everything.push(liveTestsXML);
